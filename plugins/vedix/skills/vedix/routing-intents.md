...
| 8 | full-pipeline | "research X", "investigate", "study", `/vedix <topic>` | all 12 | topic + domain |
...
- If user provides `/vedix` explicitly OR `--full`: always route to full-pipeline regardless of phrasing.
